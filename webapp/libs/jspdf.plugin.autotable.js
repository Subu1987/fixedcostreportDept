...
})(typeof globalThis !== 'undefined' ? globalThis : typeof this !== 'undefined' ? this : typeof window !== 'undefined' ? window : typeof self !==
	'undefined' ? self : global,
	function(__WEBPACK_EXTERNAL_MODULE__964__) {
		return /******/ (function() { // webpackBootstrap
			...
			var __webpack_modules__ = ({
				...
				/***/
					...
					exports.getPageAvailableWidth = exports.parseSpacing = exports.getFillStyle = exports.addTableBorder = exports.getStringWidth =
						void 0;
				...
				/***/
					...
					function parseHtml(doc, input, window, includeHiddenHtml, useCss) {
						...
						for (var i = 0; i < tableElement.rows.length; i++) {
							...
							var tagName = (_b = (_a = element === null || element === void 0 ? void 0 : element.parentElement) === null || _a === void 0 ?
								void 0 : _a.tagName) === null || _b === void 0 ? void 0 : _b.toLowerCase();
				...
				/***/
					...
					function shouldPrintOnCurrentPage(doc, row, remainingPageSpace, table) {
						...
						if (minRowHeight > maxRowHeight) {
							console.error("Will not be able to print row ".concat(row.index,
						...
						if (rowHigherThanPage) {
							if (rowHasRowSpanCell) {
								console.error("The content of row ".concat(row.index,
			...
			! function() {
				...
				exports.Cell = exports.Column = exports.Row = exports.Table = exports.CellHookData = exports.__drawTable = exports.__createTable =
					exports.applyPlugin = void 0;
